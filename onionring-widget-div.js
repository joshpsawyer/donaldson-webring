...
<table>
  ...
  tag.insertAdjacentHTML('afterbegin', `
    <div class='webring'>
      <div class='webring-prev'><a href='${sites[previousIndex].url}'>${sites[previousIndex].name}</a></div>
      <div class='webring-info'><a href='${indexPage}'><strong>${ringName}</strong></a></div>
      <div class='webring-next'><a href='${sites[nextIndex].url}'>${sites[nextIndex].name}</a></div>
    </div>
  `);
